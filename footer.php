     ...
     <body class="bg-color text-center">
          <div style="background:gray" class="mt-3 pt-3 pb-3 d-flex flex-col">
               <div class="d-flex jcc">
                    <div style="width:200px;" class="mr-2 mb-2">
                         ...
                         <div class="d-flex flex-col">
                              <a class="text-deco-none py-sm text-black footer-hover" align="left" href="index.php?showroom=1">1BHK</a>
                              <a class="text-deco-none py-sm text-black footer-hover" align="left" href="index.php?showroom=2">2BHK </a>
                              <a class="text-deco-none py-sm text-black footer-hover" align="left" href="index.php?showroom=3">3BHK</a>
                         </div>
                    </div>
                    <div style="width:200px;" class="mr-2 mb-2">
               ...
               <div>
                    ...
                    <b>Delveloped By: Manish Gupta ,Juili warwatkar,Rachel Calvin  </b>
                    </div>
          </div>
     </body>
</html>